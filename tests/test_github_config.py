"""Tests for homebrew-vectrade GitHub configuration files."""
...
class TestCIWorkflowContent:
    ...
    def test_validates_ruby_syntax(self, ci_content):
        assert "ruby -c" in ci_content or "ruby" in ci_content
    ...
    def test_has_multiple_jobs(self, ci_content):
        # Should have at least lint and test jobs
...
class TestIssueTemplates:
    ...
    def test_bug_report_mentions_brew(self):
        content = (ISSUE_TEMPLATE_DIR / "bug_report.md").read_text()
